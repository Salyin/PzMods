...
DTBaseGameCharacterDetails.DoTraits = function()
    ...
    local veryUnderweight = TraitFactory.addTrait("Very Underweight", getText("UI_trait_veryunderweight"), -16, getText("UI_trait_veryunderweightdesc"), false);
    ...
    local obese = TraitFactory.addTrait("Obese", getText("UI_trait_obese"), -16, getText("UI_trait_obesedesc"), false);
    ...
    TraitFactory.addTrait("PhysicallyActive", getText("UI_trait_PhysicallyActive"), 6, getText("UI_trait_PhysicallyActiveDesc"), false);
...
DTBaseGameCharacterDetails.DoNewCharacterInitializations = function(playernum, character)
    ...
    if player:getModData().DTKillsPath == nil then
        ...
        elseif player:HasTrait("Desensitized") then
            ...
            player:getModData().DTKillsPath = 4;
        end
    end
    ...
    if player:getModData().DTalcoholicTrait == nil then
        if player:HasTrait("Alcoholic") then
            player:getModData().DTalcoholicTrait = -44640;
        else
            player:getModData().DTalcoholicTrait = 0;
        end
    end
    if player:getModData().DTtimeSinceLastDrink == nil then
    ...
    if player:getModData().DTangerIntelligence == nil then
        player:getModData().DTangerIntelligence = false;
    end
    if player:getModData().DTPlantsKnowledge == nil then
        player:getModData().DTPlantsKnowledge = 0;
    end
    -- INITIALIZATION FOR ALLERGIES
    if player:getModData().DTFoodAllergy == nil then
        player:getModData().DTFoodAllergy = 0;
    end
    if player:getModData().DTDrugsAllergy == nil then
        player:getModData().DTDrugsAllergy = 0;
    end
    -- INITIALIZATION FOR PASSING OUT
    if player:getModData().DTpassingOut == nil then
        player:getModData().DTpassingOut = 0;
    end
    if player:getModData().DTpassingOutQuietTime == nil then
        player:getModData().DTpassingOutQuietTime = 0;
    end
    -- INITIALIZATION FOR FLIMSY/FRAIL TRAITS
    if player:getModData().DTCurrentStrXPLevel == nil then
        player:getModData().DTCurrentStrXPLevel = 0;
    end
    -- INITIALIZATION FOR FLABBY/BRITTLEKNEES
    if player:getModData().DTCurrentFitXPLevel == nil then
        player:getModData().DTCurrentFitXPLevel = 0;
    end
    -- INITIALIZATION FOR ADDICTED TO CAFFEINE TRAIT
    if player:getModData().DTaddictedToCaffeineTrait == nil then
        if player:HasTrait("AddictedToCaffeine") then
            player:getModData().DTaddictedToCaffeineTrait = -10080;
        else
            player:getModData().DTaddictedToCaffeineTrait = 0;
        end
    end
    if player:getModData().DTtimeSinceLastCaffeine == nil then
        player:getModData().DTtimeSinceLastCaffeine = 0;
    end
    if player:getModData().DTcaffeineOnBody == nil then
...
DTBaseGameCharacterDetails.DoExistingCharacterInitializations = function(player)
    ...
    if (player:getModData().DTKillsPath == nil or player:getModData().DTKillscheck2 == nil or
        ...
        player:getModData().DTtimesinceLastKill == nil or player:getModData().DTalcoholicTrait == nil or
        player:getModData().DTtimeSinceLastDrink == nil or player:getModData().DTthresholdToObtainLoseAnorexy == nil or
        ...
        player:getModData().DTunhappynessIntelligence == nil or player:getModData().DTboredomIntelligence == nil or
        player:getModData().DTangerIntelligence == nil or player:getModData().DTPlantsKnowledge == nil or
        player:getModData().DTFoodAllergy == nil or player:getModData().DTDrugsAllergy == nil or
        player:getModData().DTpassingOut == nil or player:getModData().DTpassingOutQuietTime == nil or
        player:getModData().DTCurrentStrXPLevel == nil or player:getModData().DTCurrentFitXPLevel == nil or
        player:getModData().DTaddictedToCaffeineTrait == nil or player:getModData().DTtimeSinceLastCaffeine or
        player:getModData().DTcaffeineOnBody == nil) then
