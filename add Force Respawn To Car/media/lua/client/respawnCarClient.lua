...
local function playerName_process(player)
    ...
    ----------------------------------------------------------------------------------------------------
    if plyName ~= RIC_Name1  and RIC_CheckName_counter == 1   and RIC_Name1  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 1 : " .. (RIC_Name1))  elseif RIC_CheckName_counter == 1   and  RIC_Name1  == nil then RIC_CheckName_counter = 39  end
    if plyName ~= RIC_Name2  and RIC_CheckName_counter == 40  and RIC_Name2  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 2 : " .. (RIC_Name2))  elseif RIC_CheckName_counter == 40  and  RIC_Name2  == nil then RIC_CheckName_counter = 79  end
    if plyName ~= RIC_Name3  and RIC_CheckName_counter == 80  and RIC_Name3  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 3 : " .. (RIC_Name3))  elseif RIC_CheckName_counter == 80  and  RIC_Name3  == nil then RIC_CheckName_counter = 119 end
    if plyName ~= RIC_Name4  and RIC_CheckName_counter == 120 and RIC_Name4  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 4 : " .. (RIC_Name4))  elseif RIC_CheckName_counter == 120 and  RIC_Name4  == nil then RIC_CheckName_counter = 159 end
    if plyName ~= RIC_Name5  and RIC_CheckName_counter == 160 and RIC_Name5  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 5 : " .. (RIC_Name5))  elseif RIC_CheckName_counter == 160 and  RIC_Name5  == nil then RIC_CheckName_counter = 199 end
    if plyName ~= RIC_Name6  and RIC_CheckName_counter == 200 and RIC_Name6  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 6 : " .. (RIC_Name6))  elseif RIC_CheckName_counter == 200 and  RIC_Name6  == nil then RIC_CheckName_counter = 239 end
    if plyName ~= RIC_Name7  and RIC_CheckName_counter == 240 and RIC_Name7  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 7 : " .. (RIC_Name7))  elseif RIC_CheckName_counter == 240 and  RIC_Name7  == nil then RIC_CheckName_counter = 279 end
    if plyName ~= RIC_Name8  and RIC_CheckName_counter == 280 and RIC_Name8  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 8 : " .. (RIC_Name8))  elseif RIC_CheckName_counter == 280 and  RIC_Name8  == nil then RIC_CheckName_counter = 319 end
    if plyName ~= RIC_Name9  and RIC_CheckName_counter == 320 and RIC_Name9  ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 9 : " .. (RIC_Name9))  elseif RIC_CheckName_counter == 320 and  RIC_Name9  == nil then RIC_CheckName_counter = 359 end
    if plyName ~= RIC_Name10 and RIC_CheckName_counter == 360 and RIC_Name10 ~= nil then RIC_CheckName = RIC_CheckName +1 ; player:Say(getText('IGUI_RIC_SeatNumber').." 10 : ".. (RIC_Name10)) elseif RIC_CheckName_counter == 360 and  RIC_Name10 == nil then RIC_CheckName_counter = 361 end
        
    if RIC_CheckName_counter == 361 then 

        if RIC_CheckName == 0 then 
            player:Say(getText('IGUI_RIC_JustYou'))
        else
            local vehicle = player:getVehicle()
            if RIC_CheckName_counter == 361 and vehicle                            and
               ...
               vehicle:getScript():getFullName() ~= "Base.BoatMotor_Ground"        then
                local msg = getText("IGUI_RIC_kick_the_disconnected_players_info")--"To kick the disconnected players, the option is visible from the outside, open door."
                player:setHaloNote(msg, 222, 222, 222, 400)
            elseif RIC_CheckName_counter == 361 and vehicle then
                local msg = getText("IGUI_RIC_kick_the_disconnected_players_info_Boat")--"To kick the disconnected players, the option is visible from Inside."
                player:setHaloNote(msg, 222, 222, 222, 400)
            end
        end
        -------------------------------------------------------------
...
local function RespawnINcar_OnServerCommand(module, command, arguments)
    ...
    -------------------------------------------------------------------
    elseif  module == "RespawnINcar_expulse_players"   	 then 		    player:Say(getText("IGUI_RIC_playerIsExpulsed") .. tostring(arguments[1]) .. getText("IGUI_RIC_Is_Expulsed"))
        if getActivatedMods():contains("AvatarOffline") or getActivatedMods():contains("Avatar USER") then
            local Avatar_Item_Created = AvatarFUNC.CreateAvatarInInventory(player,arguments[1],false) 
            AvatarFUNC.DropAvatarFromInventory(player,Avatar_Item_Created) 
        end
    -------------------------------------------------------------------  
    elseif  module == "RespawnINcar_Text"                then           player:Say(getText(arguments[1])) 
    -------------------------------------------------------------------  
    elseif  module == "RespawnINcar_Text2"               then           player:Say(tostring(narguments[1])) 
    -------------------------------------------------------------------  
    end
end
--------------------------------------------------------
...
-------------------------------------------------------------------
    ...
    if player:getHoursSurvived() < 0.01 then
        ...
        return
	elseif RVInterior and RVInterior.playerInsideInterior(player) then
        Events.OnPlayerUpdate.Remove(OnStartGame)
        return
    end
    ----------------------------------------------------------------------------------------------------------------------------------------
...
context:addOption(getText("IGUI_RIC_checkNames"), worldobjects, respawnVehicle.CheckName, player)
end
--------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------
local KeyMenu = context:addOption(getText("IGUI_RIC_Expulse_player_to"),worldobjects)
local subMenu = ISContextMenu:getNew(context)
-------------------------------------------
respawnVehicle.context = context
respawnVehicle.subMenu = subMenu
context:addSubMenu(KeyMenu, subMenu)
-------------------------------------------------------------------------------------------------
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 1', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,1) 
if VEHICLE_TARGETED_MAX_SEAT == 1 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 2', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,2)
if VEHICLE_TARGETED_MAX_SEAT == 2 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 3', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,3)
if VEHICLE_TARGETED_MAX_SEAT == 3 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 4', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,4)
if VEHICLE_TARGETED_MAX_SEAT == 4 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 5', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,5)
if VEHICLE_TARGETED_MAX_SEAT == 5 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 6', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,6)
if VEHICLE_TARGETED_MAX_SEAT == 6 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 7', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,7)
if VEHICLE_TARGETED_MAX_SEAT == 7 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 8', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,8)
if VEHICLE_TARGETED_MAX_SEAT == 8 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 9', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,9)
if VEHICLE_TARGETED_MAX_SEAT == 9 then return end
subMenu:addOption(getText('IGUI_RIC_SeatNumber')..' 10', worldobjects, respawnVehicle.expulsePlayer,player,vehicle,10)
end
------------------------------------------------------------------------------------
...
vehicle:getScript():getFullName() ~= "Base.BoatMotor"               and 
vehicle:getScript():getFullName() ~= "Base.BoatMotor_Ground"        then 
player:Say(getText("IGUI_RIC_You_should_getout_vehicle"))--Say("You should get out vehicle") 
return 
end
local vehicleTest = player:getUseableVehicle()
if (not vehicleTest and not vehicleTestBoat) or (vehicleTest ~= vehicle and vehicleTestBoat ~= vehicle) then player:Say(getText("IGUI_RIC_You_should_get_near_vehicle")) return end --"You should get near vehicle"
