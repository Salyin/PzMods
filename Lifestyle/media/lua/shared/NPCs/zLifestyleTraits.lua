...
local function onGameBoot()
		...
		-- TONE DEAF
		local tonedeaf = TraitFactory.addTrait("ToneDeaf", getText("UI_trait_tonedeaf"), -2, getText("UI_trait_tonedeafdesc"), false, false);

		-- PARTY ANIMAL
		local partyanimal = TraitFactory.addTrait("PartyAnimal", getText("UI_trait_partyanimal"), 3, getText("UI_trait_partyanimaldesc"), false, false);
		partyanimal:addXPBoost(Perks.Dancing, 2)
