...
function PlayerIsDancingToMusic:update()
	...
	if self.AnimDelayStart == 40 and self.criticalFailure == 2 and self.fallSoundScream == 0 then
		...
		self.character:getEmitter():playSound(self.fallSoundScream);
		
	elseif self.AnimDelayStart == 75 and self.criticalFailure == 2 and self.fallSound == 0 then
...
function PlayerIsDancingToMusic:new(character, actionType)
	...
	o.AnimDelayStart = 0
	o.AnimDelayEnd = 600
	o.AnimDelayEndFail = 310
	o.AnimDelayEndFailCrit = 360
	o.idxAnim = 0
